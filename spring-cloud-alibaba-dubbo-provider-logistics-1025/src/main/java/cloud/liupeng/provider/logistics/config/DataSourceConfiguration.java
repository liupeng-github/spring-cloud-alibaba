package cloud.liupeng.provider.logistics.config;
...
public class DataSourceConfiguration {
     ...
     */
    @Bean("dataSource")
    @ConfigurationProperties(prefix = "spring.datasource.dynamic.datasource.logistics")
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(JpaVendorAdapter jpaVendorAdapter) {
        ...
        // 注入 entity 所在包路径
        localContainerEntityManagerFactoryBean.setPackagesToScan("cloud.liupeng.domain.entity.logistics");
