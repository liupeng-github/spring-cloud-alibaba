...
public class ServicePayApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("后台启动：nohup java -jar spring-cloud-alibaba-service-pay-2024.jar --server.port=不重复端口");
        System.out.println("spring-cloud-alibaba-service-pay - 启动成功! 默认端口号：2024 \n " +
                " ,---.    .--..-.   .-.\n" +
                " | .-.\\  / /\\ \\\\ \\_/ )/\n" +
                " | |-' )/ /__\\ \\\\   (_)\n" +
                " | |--' |  __  | ) (   \n" +
